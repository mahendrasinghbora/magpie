...
const DEFAULT_CATEGORIES = [
  ...
  { name: 'Groceries', icon: 'ShoppingBasket', color: '#84cc16', isCustom: false, isTransfer: false, order: 3 },
  { name: 'Quick Commerce', icon: 'Zap', color: '#eab308', isCustom: false, isTransfer: false, order: 4 },
  { name: 'Bike Taxi', icon: 'Bike', color: '#14b8a6', isCustom: false, isTransfer: false, order: 5 },
  { name: 'Auto', icon: 'CarTaxiFront', color: '#06b6d4', isCustom: false, isTransfer: false, order: 6 },
  ...
  { name: 'Fuel & Vehicle', icon: 'Fuel', color: '#8b5cf6', isCustom: false, isTransfer: false, order: 9 },
  { name: 'Shopping', icon: 'ShoppingBag', color: '#d946ef', isCustom: false, isTransfer: false, order: 10 },
  { name: 'Bills & Utilities', icon: 'Receipt', color: '#ec4899', isCustom: false, isTransfer: false, order: 11 },
  { name: 'Household Help', icon: 'HandHelping', color: '#f43f5e', isCustom: false, isTransfer: false, order: 12 },
  { name: 'Entertainment', icon: 'Film', color: '#fb7185', isCustom: false, isTransfer: false, order: 13 },
  { name: 'Sports & Fitness', icon: 'Dumbbell', color: '#22c55e', isCustom: false, isTransfer: false, order: 14 },
  { name: 'Health', icon: 'Heart', color: '#ef4444', isCustom: false, isTransfer: false, order: 15 },
  ...
  { name: 'Subscriptions', icon: 'RefreshCw', color: '#a855f7', isCustom: false, isTransfer: false, order: 20 },
  { name: 'Personal Care', icon: 'Scissors', color: '#ec4899', isCustom: false, isTransfer: false, order: 21 },
  { name: 'Gifts & Donations', icon: 'Gift', color: '#f472b6', isCustom: false, isTransfer: false, order: 22 },
